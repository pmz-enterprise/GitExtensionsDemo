...
class PS(object):
    ...
    def load_lighttxt(self, filename=None):
        ...
        """
        self.L = psuti.load_lighttxt(filename)
    ...
    def load_lightnpy(self, filename=None):
        ...
        """
        self.L = psuti.load_lightnpy(filename)
    ...
    def load_images(self, foldername=None, ext=None):
        ...
        """
        self.M, self.height, self.width = psuti.load_images(foldername, ext)
    ...
    def load_npyimages(self, foldername=None):
        ...
        :param foldername: foldername
        """
        self.M, self.height, self.width = psuti.load_npyimages(foldername)
    ...
    def load_mask(self, filename=None):
        ...
        mask = psuti.load_image(filename=filename)
    ...
    def disp_normalmap(self, delay=0):
        ...
        :return: None
        """
        psuti.disp_normalmap(normal=self.N, height=self.height, width=self.width, delay=delay)
    ...
    def save_normalmap(self, filename=None):
        ...
        :return: None
        """
        psuti.save_normalmap_as_npy(filename=filename, normal=self.N, height=self.height, width=self.width)
    ...
    def solve(self):
        ...
        #不得不提醒一下，看到上面那条判据就该意识到其实读出来的数据是转置过的
        #############################################
